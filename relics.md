...
## Tier 1 — PICK: Abundance

| Relic | Effect | Verdict |
|-------|--------|---------|
| **Abundance** | +10 all non-combat skills, +2 bonus XP per drop (affected by multiplier), 2 coins per XP (toggleable banking) | **PICK** — +10 boost is massive for early access to content. GP generation funds buyable skills. Bonus XP stacks with multiplier. |
| Endless Harvest | Auto-bank gathered resources, infinite gathering from depleting sources, 2x resources from Fish/WC/Mining | Good for gathering but we're a mage build focused on PvM. AFK gathering is nice but Abundance covers more skills. |
