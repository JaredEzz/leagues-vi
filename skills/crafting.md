...
You need **73 real Crafting** (83 effective) to craft Confliction Gauntlets. With the dragonstone path, you hit this around:
- ~1.3 hours into the dragonstone grind at 16x
- ~2.7 hours at 12x

Prioritize getting to 73 real Crafting before trying to craft the gauntlets.

## Other Methods (Worse)

| Method | At 16x | Verdict |
|--------|--------|---------|
| Untransmuted rubies from Toci's | 3.8M/hr | Fine without Transmutation |
| D'hide bodies | 5-7M/hr | Faster but needs hide supply from Slayer |
| Glassblowing | ~2M/hr | Never worth it |
| Gold jewelry | ~2.5M/hr | Slower than diamonds |
| Battlestaves | ~4.8M/hr | Zaff is Misthalin — LOCKED |
